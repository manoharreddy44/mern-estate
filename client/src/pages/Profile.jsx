     ...
     <div className="flex flex-col gap-4">
      ...
      <div key={listing._id} className="border rounded-lg p-3 flex justify-between items-center gap-4"> 
        <Link to={`/listing/${listing._id}`}>
          <img src={listing.imageUrls[0]} alt="listing cover" className='h-16 w-16 object-cointain' />
        </Link>
        <Link className="text-slate-700 font-semibolt flex-1 hover:underline truntake" to={`/listing/${listing._id}`}>
          <p>{listing.name}</p>
        </Link>
